    ...
    <div className="BenefitsMainContainer">
      <div className="container">
        <h1 className="text-light mb-5">
          Benefits of trading Crypto with Paypenny
        </h1>
        <div className="row g-3">
          <div className="col-12 col-md-6 col-lg-4" data-aos="zoom-in-right">
            <div
          ...
          <div className="col-12 col-md-6 col-lg-4" data-aos="zoom-out">
            <div
              className="benefitsCards
            ">
              <img
          ...
          <div className="col-12 col-md-6 col-lg-4" data-aos="zoom-in-left">
            <div
              className="benefitsCards
            ">
              <img
