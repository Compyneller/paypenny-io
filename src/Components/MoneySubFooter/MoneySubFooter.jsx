    ...
    <div className="subFooterMainContainer">
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-6 col-lg-3">
            <div className="subFooterCard">
              ...
              <div className="subFooterContent">
                <h5>24/7 Money Transfer worldwide </h5>
                <p>
                  Send Money worldwide whenever you want to with our iOS &
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="subFooterCard">
              ...
              />
              <div className="subFooterContent">
                <h5>1,20,000+ happy customers & counting</h5>
                <p>
                  We have gained the trust of 1,20,000+ people to manage their
        ...
        <h1
          ...
          Trusted by over 1,20,000+ users
        </h1>
      </div>
    </div>
  );
