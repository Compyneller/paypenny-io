        ...
        <div className="row">
          <div className="col-12 col-md-6 col-lg-3">
            <div className="subFooterCard">
              ...
              <div className="subFooterContent">
                <h5>24/7 Crypto Transfer to anywhere</h5>
                <p>
                  Send Crypto to anywhere whenever you want to with our iOS &
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="subFooterCard">
              ...
              <div className="subFooterContent">
                ...
                <p>
                  Our business’s main asset is crypto currency. We have handled
                  crypto currency worth over $100+ Million in the last year.
                </p>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-6 col-lg-3">
            <div className="subFooterCard">
              ...
              />
              <div className="subFooterContent">
                <h5>120,000+ happy customers & counting</h5>
                <p>
                  We have gained the trust of 120,000+ people to manage their
                  crypto currency and the numbers are increasing day by day.
                </p>
              </div>
            </div>
          </div>
